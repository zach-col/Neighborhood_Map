...
function populateInfoWindow(marker, infowindow) {
 ...
 "&v=20150214&m=foursquare&client_secret=INSERT_FOURSQUARE_API_CLIENT_SECRET_HERE&client_id=INSERT_FOURSQUARE_API_CLIENT_ID_HERE";
      ...
      }).fail(function() { alert('The Foursquare API is having problems connecting.... what if there were no problems?.... You might call me a dreamer but Im not the only one.'); });
